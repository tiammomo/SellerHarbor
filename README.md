...
- 当前按单店铺运行，但保留多店铺扩展口，后续同一租户可管理多个 Temu / TikTok Shop 店铺。
...
- Store Registry: `http://localhost:38081/api/stores/registry`
...
- [多店铺管理规划](docs/STORE_MANAGEMENT.md)
- [Docker 组件化运行](docs/DOCKER.md)
- [Temu 接入计划](docs/TEMU_INTEGRATION.md)
